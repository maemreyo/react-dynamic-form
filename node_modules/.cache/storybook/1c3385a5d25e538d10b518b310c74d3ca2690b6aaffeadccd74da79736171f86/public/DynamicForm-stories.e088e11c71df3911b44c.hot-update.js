...
var Template = function (args) { return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(___WEBPACK_IMPORTED_MODULE_2__.DynamicForm, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({}, args)); };
// --- Examples ---
...
AdvancedFeatures.args = {
    ...
    autoSave: {
        interval: 5000,
        save: function (data) { return console.log('Auto-saving:', data); },
    },
    ...
    onChange: function (data) { return console.log('Debounced change:', data); },
    onFormReady: function (form) {
        // Reset button
        var resetButton = document.createElement('button');
        resetButton.textContent = 'Reset Form';
        resetButton.onclick = function () { return form.reset(); };
...
AdvancedFeatures.play = function (_a) { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, [_a], void 0, function (_b) {
    var canvas;
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, step('Simulate Auto-save', function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, _storybook_test__WEBPACK_IMPORTED_MODULE_1__.userEvent.type(canvas.getByLabelText('Auto-save Field'), 'Auto-save Test')];
                                case 1:
                                    _a.sent();
                                    // Wait for auto-save to trigger (5 seconds)
                                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 5100); })];
                                case 2:
                                    // Wait for auto-save to trigger (5 seconds)
                                    _a.sent();
                                    return [2 /*return*/];
            ...
            case 1:
                _c.sent();
                return [4 /*yield*/, step('Simulate Local Storage', function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, _storybook_test__WEBPACK_IMPORTED_MODULE_1__.userEvent.type(canvas.getByLabelText('Local Storage Field'), 'Local Storage Test')];
                                case 1:
                                    _a.sent();
                                    // Manually trigger saving to local storage (for demonstration)
                                    window.localStorage.setItem('form-data', JSON.stringify({ localStorageField: 'Local Storage Test' }));
            ...
            case 2:
                _c.sent();
                return [4 /*yield*/, step('Simulate Reset on Submit', function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, _storybook_test__WEBPACK_IMPORTED_MODULE_1__.userEvent.type(canvas.getByLabelText('Reset Field'), 'New Value')];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, _storybook_test__WEBPACK_IMPORTED_MODULE_1__.userEvent.click(canvas.getByRole('button', { name: 'Submit' }))];
                                case 2:
                                    _a.sent();
            ...
            case 3:
                _c.sent();
                return [4 /*yield*/, step('Simulate Focus First Error on Submit', function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0: 
            ...
            case 4:
                _c.sent();
                return [4 /*yield*/, step('Simulate Debounce on Change', function () { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, _storybook_test__WEBPACK_IMPORTED_MODULE_1__.userEvent.type(canvas.getByLabelText('Debounce Field'), 'Debounce Test')];
                                case 1:
                                    _a.sent();
...
ComprehensiveForm.args = {
    ...
    renderLayout: function (_a) {
        var children = _a.children, rest = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__rest)(_a, ["children"]);
    ...
    renderErrorSummary: function (errors, formClassNameConfig) { return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: formClassNameConfig === null || formClassNameConfig === void 0 ? void 0 : formClassNameConfig.formContainer },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { className: formClassNameConfig === null || formClassNameConfig === void 0 ? void 0 : formClassNameConfig.label }, "Validation Errors:"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, Object.entries(errors).map(function (_a) {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { key: key, className: formClassNameConfig === null || formClassNameConfig === void 0 ? void 0 : formClassNameConfig.errorMessage },
                key,
                ": ",
    ...
    config: {
        ...
        asyncEmail: {
            ...
            validation: {
                required: { value: true, message: 'This field is required' },
                validate: function (value) { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, void 0, function () {
                    var isValid;
                    return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, mockCheckEmailExists(value)];
                            case 1:
                                isValid = _a.sent();
                                return [2 /*return*/, isValid || 'Email already exists (async check)'];
                        }
                    });
                }); },
            },
    ...
    formClassNameConfig: {
        ...
        button: 'bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full', // Thêm w-full
    },
    validationMessages: {
...
var mockCheckEmailExists = function (email) { return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(void 0, void 0, Promise, function () {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
...
//# sourceMappingURL=DynamicForm-stories.e088e11c71df3911b44c.hot-update.js.map