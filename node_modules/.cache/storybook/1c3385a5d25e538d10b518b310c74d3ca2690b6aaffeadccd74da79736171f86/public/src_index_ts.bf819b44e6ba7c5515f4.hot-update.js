...
var FormFooter = function (_a) {
    var footer = _a.footer, renderSubmitButton = _a.renderSubmitButton, isSubmitting = _a.isSubmitting, showErrorSummary = _a.showErrorSummary, errors = _a.errors, formClassNameConfig = _a.formClassNameConfig, renderErrorSummary = _a.renderErrorSummary;
    var errorSummary = showErrorSummary && Object.keys(errors).length > 0
        ? renderErrorSummary
            ? renderErrorSummary({ errors: errors, formClassNameConfig: formClassNameConfig }) // Use custom renderer if provided
            : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__.ErrorSummary, {
                errors: errors,
                formClassNameConfig: formClassNameConfig,
            }) // Use default ErrorSummary component
        : null;
...
//# sourceMappingURL=src_index_ts.bf819b44e6ba7c5515f4.hot-update.js.map