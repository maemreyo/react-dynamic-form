...
var FormRenderer = function (_a) {
    var onSubmit = _a.onSubmit, className = _a.className, _b = _a.formClassNameConfig, formClassNameConfig = _b === void 0 ? {} : _b, style = _a.style, _c = _a.layout, layout = _c === void 0 ? 'grid' : _c, layoutConfig = _a.layoutConfig, horizontalLabel = _a.horizontalLabel, theme = _a.theme, header = _a.header, fieldsToRender = _a.fieldsToRender, fields = _a.fields, config = _a.config, footer = _a.footer, _d = _a.showSubmitButton, showSubmitButton = _d === void 0 ? true : _d, renderSubmitButton = _a.renderSubmitButton, _e = _a.showErrorSummary, showErrorSummary = _e === void 0 ? false : _e, labelWidth = _a.labelWidth, disableAutocomplete = _a.disableAutocomplete, showInlineError = _a.showInlineError, renderFormContent = _a.renderFormContent, renderFormFooter = _a.renderFormFooter, customInputs = _a.customInputs, renderErrorSummary = _a.renderErrorSummary;
...
//# sourceMappingURL=src_index_ts.5761f78d678da0f592ae.hot-update.js.map