...
var createValidationSchema = function (config, globalValidationMessages) {
    ...
    for (var fieldId in config) {
        ...
        for (var fieldId_1 in config) {
            var fieldConfig_1 = config[fieldId_1];
            var validation_1 = fieldConfig_1.validation, type_1 = fieldConfig_1.type, validationMessages_1 = fieldConfig_1.validationMessages;
            // Merge global and field-level validation messages
            var mergedValidationMessages = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, globalValidationMessages), validationMessages_1);
            if (type_1 === undefined) {
                console.warn("Field type is undefined for field: ".concat(fieldId_1));
            }
            var fieldSchema = (0,_ValidationSchemaRegistry__WEBPACK_IMPORTED_MODULE_1__.getValidationSchema)(type_1) || yup__WEBPACK_IMPORTED_MODULE_0__.mixed();
            if (validation_1) {
                var validate = validation_1.validate, otherValidations = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(validation_1, ["validate"]);
                for (var rule in otherValidations) {
                    if (otherValidations.hasOwnProperty(rule)) {
                        var ruleValue = validation_1[rule];
...
//# sourceMappingURL=src_index_ts.2d5d902e75820f5f0561.hot-update.js.map