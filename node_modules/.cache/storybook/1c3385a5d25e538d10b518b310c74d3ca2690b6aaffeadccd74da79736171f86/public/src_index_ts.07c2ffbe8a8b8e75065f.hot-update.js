...
var DynamicForm = function (_a) {
    var _b = _a.config, config = _b === void 0 ? {} : _b, onChange = _a.onChange, onSubmit = _a.onSubmit, formOptions = _a.formOptions, header = _a.header, footer = _a.footer, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c, _d = _a.disableForm, disableForm = _d === void 0 ? false : _d, _e = _a.showSubmitButton, showSubmitButton = _e === void 0 ? true : _e, autoSave = _a.autoSave, _f = _a.resetOnSubmit, resetOnSubmit = _f === void 0 ? false : _f, _g = _a.focusFirstError, focusFirstError = _g === void 0 ? false : _g, className = _a.className, _h = _a.formClassNameConfig, formClassNameConfig = _h === void 0 ? {} : _h, style = _a.style, _j = _a.layout, layout = _j === void 0 ? 'flex' : _j, _k = _a.layoutConfig, layoutConfig = _k === void 0 ? {
        gap: '10px',
        columns: 1,
        minWidth: '300px',
...
//# sourceMappingURL=src_index_ts.07c2ffbe8a8b8e75065f.hot-update.js.map