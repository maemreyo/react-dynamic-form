...
var TextInput = function (_a) {
    var id = _a.id, fieldConfig = _a.fieldConfig, _b = _a.formClassNameConfig, formClassNameConfig = _b === void 0 ? {} : _b, disableAutocomplete = _a.disableAutocomplete, horizontalLabel = _a.horizontalLabel, labelWidth = _a.labelWidth;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles__WEBPACK_IMPORTED_MODULE_1__.InputWrapper, { "$horizontalLabel": horizontalLabel, "$labelWidth": labelWidth, className: formClassNameConfig.inputWrapper },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles__WEBPACK_IMPORTED_MODULE_1__.Input, (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, field, { className: formClassNameConfig.input, id: id, autoComplete: disableAutocomplete ? 'off' : undefined }))));
};
...
//# sourceMappingURL=src_index_ts.9bcf32784ee3fb6391bf.hot-update.js.map