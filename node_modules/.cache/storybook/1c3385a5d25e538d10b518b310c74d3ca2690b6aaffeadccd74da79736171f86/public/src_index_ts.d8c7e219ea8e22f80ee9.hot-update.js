 ...
 */
var mergeClassNames = function (fieldConfig, formState, defaultClassNames, formClassNames, fieldClassNames) {
    var mergedClassNames = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, defaultClassNames);
            ...
            for (var key in source) {
                ...
                if (typeof sourceValue === 'string') {
                    target[key] = targetValue
                        ? "".concat(targetValue, " ").concat(sourceValue)
                        : sourceValue;
                }
                else if (typeof sourceValue === 'function') {
                    var result = sourceValue(fieldConfig, formState);
                    target[key] = targetValue
                        ? "".concat(targetValue, " ").concat(result)
                        : result;
                }
                else if (typeof sourceValue === 'object') {
                    target[key] = targetValue
                        ? merge(targetValue, sourceValue)
                        : (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, sourceValue);
                }
            }
        }
        return target;
    ...
    return mergedClassNames; // Ép kiểu
};
...
//# sourceMappingURL=src_index_ts.d8c7e219ea8e22f80ee9.hot-update.js.map