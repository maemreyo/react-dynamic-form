...
var DynamicForm = function (_a) {
    var _b = _a.config, config = _b === void 0 ? {} : _b, onChange = _a.onChange, onSubmit = _a.onSubmit, formOptions = _a.formOptions, header = _a.header, footer = _a.footer, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c, _d = _a.disableForm, disableForm = _d === void 0 ? false : _d, _e = _a.showSubmitButton, showSubmitButton = _e === void 0 ? true : _e, autoSave = _a.autoSave, _f = _a.resetOnSubmit, resetOnSubmit = _f === void 0 ? false : _f, _g = _a.focusFirstError, focusFirstError = _g === void 0 ? false : _g, className = _a.className, _h = _a.formClassNameConfig, formClassNameConfig = _h === void 0 ? {} : _h, style = _a.style, _j = _a.layout, layout = _j === void 0 ? 'grid' : _j, _k = _a.layoutConfig, layoutConfig = _k === void 0 ? {
        minWidth: '48%',
    } : _k, _l = _a.horizontalLabel, horizontalLabel = _l === void 0 ? false : _l, labelWidth = _a.labelWidth, _m = _a.enableLocalStorage, enableLocalStorage = _m === void 0 ? false : _m, _o = _a.debounceOnChange, debounceOnChange = _o === void 0 ? 0 : _o, _p = _a.disableAutocomplete, disableAutocomplete = _p === void 0 ? false : _p, _q = _a.showInlineError, showInlineError = _q === void 0 ? true : _q, _r = _a.showErrorSummary, showErrorSummary = _r === void 0 ? false : _r, _s = _a.validateOnBlur, validateOnBlur = _s === void 0 ? false : _s, _t = _a.validateOnChange, validateOnChange = _t === void 0 ? true : _t, _u = _a.validateOnSubmit, validateOnSubmit = _u === void 0 ? true : _u, theme = _a.theme, customInputs = _a.customInputs, onFormReady = _a.onFormReady, renderSubmitButton = _a.renderSubmitButton;
    ...
    var _v = (0,_features_dynamic_form__WEBPACK_IMPORTED_MODULE_1__.useFormFields)(config, formState, control), fields = _v.fields, fieldsToRender = _v.fieldsToRender, conditionalFieldsConfig = _v.conditionalFieldsConfig;
...
//# sourceMappingURL=src_index_ts.477bd1bbe98ff0c3cabb.hot-update.js.map