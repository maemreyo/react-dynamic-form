...
var DynamicForm = function (_a) {
    ...
    var LayoutComponent = useMemo(function () {
        if (renderLayout) {
            return renderLayout;
        }
        if (layout === 'flex') {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_theme_ThemeProvider__WEBPACK_IMPORTED_MODULE_3__["default"], { theme: theme || {} },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_features_dynamic_form__WEBPACK_IMPORTED_MODULE_1__.DynamicFormProvider, { form: form },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LayoutComponent, { onSubmit: onSubmitHandler, className: className, formClassNameConfig: formClassNameConfig, style: style, layout: layout, layoutConfig: layoutConfig, horizontalLabel: horizontalLabel, theme: theme },
...
//# sourceMappingURL=src_index_ts.397c4e734f7a7fd9150b.hot-update.js.map